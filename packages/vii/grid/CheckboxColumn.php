...
class CheckboxColumn extends Column
{
    ...
    public $headerOptions = ['class' => 'hidden-print w-32 text-center'];

    public $contentOptions = ['class' => 'hidden-print w-32 text-center'];
    ...
    protected function renderHeaderCellContent()
    {
        if ($this->header !== null || !$this->multiple) {
            ...
            return Html::checkBox($this->getHeaderCheckBoxName(), false, ['class' => 'select-on-check-all', 'onclick' => 'jurakit.grid.setSelectedRows($(this))']);
    ...
    protected function renderDataCellContent($model, $key, $index)
    {
        ...
        // jurakit
        $options['onclick'] = 'jurakit.grid.setSelectedRow($(this))';
