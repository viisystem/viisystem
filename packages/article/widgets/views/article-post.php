...
<div class="col-md-3 col-sm-3 col-xs-6">
	<div class="thumbnails thumbnail-style thumbnail-kenburn">
		...
		<div class="caption">
			<h3 style="height: 56px; overflow: hidden;"><a class="hover-effect text-justify" href="<?= Url::to(['/article/frontend/default/view', 'slug' => $item->slug, 'id' => $item->_id]) ?>"><?= StringHelper::truncateWords($item->title, 10); ?></a></h3>
			<p style="height: 40px; overflow: hidden;" class="text-justify"><?= StringHelper::truncateWords(strip_tags($item->content), 16); ?></p>
		</div>
	</div>
</div>